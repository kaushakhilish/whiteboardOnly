...
const ShapeProperties2 = ({ setShapes }) => {
    ...
    function fillColorInputChangeHander(e) {
        ...
        setShapes(prv => {
            let index = prv.findIndex(shp => shp.id === shapePropCompVals?.shape?.id);
            if (index >= 0) {
    ...
    return (
        <div style={style} className={styles.shapeProperitesBox}>
            <div className={styles.option}>
                <label >
                    <div style={{ border: ('2px solid ' + shapePropCompVals?.shape?.style?.stroke) }} className={styles.strokeColor} />
            ...
            <div className={styles.option}>
                <label>
                    <div style={{ backgroundColor: shapePropCompVals?.shape?.style?.fill }} className={styles.fillColor}></div>
            ...
            <div style={{width: '40px'}} className={styles.option}>
                <input onInput={strokeWidthChangeHandler} min={1} defaultValue={shapePropCompVals?.shape?.style?.strokeWidth}
